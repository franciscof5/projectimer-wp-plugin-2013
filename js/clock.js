...
function start_clock() {
	//alert('com');
	is_countdown_active = setInterval('count()', 10);
	//active_sound.play();
...
var count=function(){
	...
	var background=function(){
		...
		update(minSetup.radie,backColor,minSetup.back,0,2,ctx);
		update(minSetup.radie,backColor,minSetup.lineWidth,0,2,ctx);
	...
	secondsRemaing--;
	update(minSetup.radie,minSetup.color,minSetup.lineWidth,(secondsRemaing/focusTime)*2,0,ctx);
